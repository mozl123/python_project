...
def plot_qq1(t1, t2, n1, n2, key1, key2):
    """
    绘制两个时间序列的QQ图
    :param t1:时间序列1
    :param t2:时间序列2
    :param n1:时间序列1对应的事件个数
    :param n2:时间序列2对应的事件个数
    :param key1:时间序列1的标志
    :param key2:时间序列2的标志
    :return:t1-t2
    """
    ...
    # 绘制推文数目随时间变化曲线
    plt.plot(t1, n1, c='g', label=u"1")
    plt.scatter(t1, n1, c='g')
    plt.plot(t2, n2, c='r', label=u"2")
    plt.scatter(t2, n2, c='r')
...
def fastdtw_algorithm1(t1, t2, n1, n2, key1, key2):
    """
    快速动态时间规整算法
    :param t1:时间序列1
    :param t2:时间序列2
    :param n1:时间序列1对应的事件的个数
    :param n2:时间序列2对应的事件的个数
    :param key1:时间序列1标志
    :param key2:时间序列2标志
    :return:
    """
    ...
    # 建立对齐以后的时间序列的事件个数列表
    new_n1 = [n1_dict[item] for item in new_t1]
    new_n2 = [n2_dict[item] for item in new_t2]
    ...
    # 绘制QQ图
    plot_qq1(new_t1, new_t2, new_n1, new_n2, key1, key2)


def fastdtw_algorithm2(t1, t2, key1, key2):
    """
    快速动态时间规整算法
    :param t1:时间序列1
    :param t2:时间序列2
    ...
    plt.title(u"动态时间规整对应关系图", fontproperties='SimHei')
    plt.legend(prop={'family': 'SimHei', 'size': 15})
    plt.legend(handles=[l1, l2, ], labels=[key1, key2], loc=0)
    plt.show()

    # 绘制QQ图
    plot_qq2(new_t1, new_t2, key1, key2)

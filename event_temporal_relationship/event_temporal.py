...
def plot_qq2(t1, t2, n1, n2, key1, key2):
    """
    绘制两个时间序列的QQ图
    :param t1:时间序列1
    :param t2:时间序列2
...
def fastdtw_algorithm(t1, t2, n1, n2, key1, key2):
    """
    快速动态时间规整算法
    :param t1:时间序列1
    :param t2:时间序列2
    ...
    y1 = len(new_t1) * [1]
    y2 = len(new_t2) * [5]
    plt.scatter(new_t1, y1, c='r', label=u"1")
    plt.scatter(new_t2, y2, c='g', label=u"2")
    ...
    # 绘制QQ图
    plot_qq2(new_t1, new_t2, new_n1, new_n2, key1, key2)
